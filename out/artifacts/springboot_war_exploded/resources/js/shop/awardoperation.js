$(function() {
    ...
    var infoUrl = '/springboot/shopadmin/getawardbyid?awardId=' + awardId;
    var awardPostUrl = '/springboot/shopadmin/modifyaward';
    var isEdit = false;
    if (awardId) {
        getInfo(awardId);
        isEdit = true;
    } else {
        awardPostUrl = '/springboot/shopadmin/addaward';
    }
