$(function() {
    ...
    var maxItems = 999;
    var pageSize = 10;
    var listUrl = '/springboot/frontend/listusershopmapsbycustomer';
        ...
        $.getJSON(url, function (data) {
            if (data.success) {
                ...
                data.userShopMapList.map(function (item, index) {
                    html += ''
                        +   '<div class="card" data-id="'+ item.shop.shopId +'">'
    ...
    $('.list-div').on('click','.card',function (e) {
        ...
        window.location.href='/springboot/frontend/awardlist?shopId='+shopId;
